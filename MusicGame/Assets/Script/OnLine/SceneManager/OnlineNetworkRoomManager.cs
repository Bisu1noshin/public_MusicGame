...
namespace OnLine
{
    public class OnlineNetworkRoomManager : NetworkRoomManager
    {
        // Overrides the base singleton so we don't
        // have to cast to this type everywhere.
        public static new OnlineNetworkRoomManager singleton => (OnlineNetworkRoomManager)NetworkRoomManager.singleton;
